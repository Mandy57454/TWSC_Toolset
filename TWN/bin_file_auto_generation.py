...
def r01_388(fixed, combine):
    ...
    r01_388_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW_202412_MioSpeedCam-388.xls'
    ...
    if 'data' in r01_388_data.sheet_names():
        ...
        r01_388_data.save_as(out_r01_388)
    else:
...
def r01_only_lw(fixed, combine):
    ...
    r01_only_lw_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW_202412_MioSpeedCam-newtype_v90.xls'
    ...
    if 'data' in r01_only_lw_data.sheet_names():
        ...
        for i in range(1, sheet.number_of_rows()):
            ...
            if sheet[i, 5] == 18 or sheet[i, 5] == 19:  # 18 & 19改成1
                sheet[i, 5] = 1
            sheet[i, 7] = int(data_ver)  # Version
        r01_only_lw_data.save_as(out_r01_only_lw)
    else:
        print('data not found')
...
def r01_tw_sea_lw(fixed, combine, sea):
    ...
    r01_tw_sea_lw_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW&SEA_202412_MioSpeedCam-newtype_v93.xls'
    ...
    if 'data' in r01_tw_sea_lw_data.sheet_names():
        ...
        r01_tw_sea_lw_data.save_as(out_r01_tw_sea_lw)
    else:
        print('data not found')
...
def r12(fixed, combine, sea):
    ...
    r12_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW&SEA_202412_MioSpeedCam-newtype_v76.xls'
...
def r21(fixed, combine, average):
    ...
    r21_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW_202412_MioSpeedCam-newtype_v44.xls'
...
def r22(fixed, combine, average, sea):
    ...
    r22_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW&SEA_202412_MioSpeedCam-newtype_v48.xls'
...
def r41(average):
    ...
    r12_path = os.path.join(out_path, 'Release', 'R12', f'LW_ABBY_AMY-V{build_R12}.{build_date}.01.12-ROW',
                            f'TW&SEA_{data_ver}_MioSpeedCam-newtype_v{build_R12}.xls')
    r12_data = p.get_book(file_name=r12_path)
    r41_path = r'C:\TWSC_Toolset\TWN\SourceData\Sample\TW&SEA_202412_MioSpeedCam-newtype_v37.xls'
